  ...
  <div className="runtime-host">
    ...
    <div className="runtime-execution">
      <div className="runtime-controller">
        ...
        <p><strong>CPython 3.12 · asyncio + subprocess</strong><br/>Proposed coordination utilities; custom scope under review. Control when work starts, pauses for review or stops.</p>
