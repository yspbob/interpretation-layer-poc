        ...
        <div className="method-step-content">
          ...
          <DetailGroup>
            ...
            <Disclosure id="interpret-results" title="What conclusions would the comparison support?">
              ...
              <p>Historical backtests, authored tasks and unpublished variants are reported separately, as are tests with and without the relevant documentation. A task that states the target rule can test its application, but not the benefit of discovering it. Several tasks may test the same underlying decision. The analysis must account for that relationship rather than count every variation or repeated attempt as independent evidence. The number of cases and minimum worthwhile improvement are set before the main trial.</p>
