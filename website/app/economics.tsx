...
export function Economics() {
  return <>
    ...
    <h3>What the coding phases will record</h3>
    ...
    <div className="phase-later-note"><p>Phases 2 and 3 will record actual costs and any reuse observed in their tasks. Detailed estimates about future savings belong to a later study. <PageLink className="text-link" href="/phases#what-could-follow">See what could follow the first trial.</PageLink></p></div>
    ...
    <ProductionDifference
      ...
      poc="Phase 1 records preparation costs. The coding phases add the cost of use across their selected tasks. The guide stays unchanged. Detailed estimates of future return and a dashboard for managing rules belong to later work."
...
export function BudgetSelection() {
  return <>
    ...
    <p>We will then try the groups included in that phase on a few separate development tasks: two groups in Phase 2, and all three in Phase 3. These tasks will help us understand what preparation, coding, questions, review and corrections actually cost. They will stay out of the independent tests used to support our final conclusions.</p>
    ...
    <p>For any method using a guide, preparation uses part of that allowance. We will fix both its spending limit and the tasks sharing that cost before the comparison.</p>
    ...
    <p>Each coding comparison will use an allowance fixed for that phase and matched across its groups. A second budget level belongs to a later study if it is justified and funded. For now, conclusions about cost will apply only to the allowance and tasks actually tested.</p>
