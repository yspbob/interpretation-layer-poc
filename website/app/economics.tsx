...
export function Economics() {
  return <>
    ...
    <div className="phase-later-note"><p>Phases 2 and 3 will record actual costs and any reuse observed in their tasks. Detailed estimates about future savings belong to a later study. <PageLink className="text-link" href="/#what-could-follow">See what could follow the first trial.</PageLink></p></div>
