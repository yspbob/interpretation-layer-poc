...
if (['index.html', 'progress/index.html', 'phases/index.html', 'trial-method/index.html'].some(page => !existsSync(resolve(built, page)))) throw new Error('Run npm run build:pages first');
