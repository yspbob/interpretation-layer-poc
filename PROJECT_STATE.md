...
For website discussion, bank comments and proposed changes in the conversation until the user explicitly requests application or release. Do not edit, build or publish after each comment. The 9 September release instructions authorised the narrative/scope batch and then the banked containment requirements. Future comments remain banked until the next explicit application or release request. Match the playbook's authorial voice: use I/my for the author's recommendations and judgement, name the responsible component for procedures, and use we only for a real group. Do not imply that automated checks were independent human review.
