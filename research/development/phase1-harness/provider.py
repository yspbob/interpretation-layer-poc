...
ASSESSMENT_PROMPT_VERSION = "astra-assessment-instructions-v2"
# Exact predeclared revision; replacement preparation did not change these strings.
PROMPTS = {
