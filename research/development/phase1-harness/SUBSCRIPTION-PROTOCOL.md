...
Version: subscription-qualification-fresh-v1-proposal. Prepared 16 September 2026; not approved for dispatch. Both stopped allocations and the withdrawn reuse proposal remain preserved in their original private freezes. The configuration-record schema remains v2.

## Treatment of prior exposure

The user selected unused decision families. The [fresh preparation](FRESH-QUALIFICATION-PREPARATION.md) retains Q06 only after the documented cross-model exposure audit and replaces Q01/Q05/Q08 with Q09/Q10/Q11. All Q06 positions in the two stopped allocations were unrun; local packet materialisation and synthetic rehearsals are disclosed. Q02/Q03/Q04/Q07 remain development. The earlier infrastructure-only reuse exception is withdrawn and is not part of this protocol.

The new bank preserves the 144-position role/item/repetition structure, substituting family identifiers without selecting positions on earlier scores. Collect new first responses for every position and carry forward no earlier answer or score. No recorded prior evaluation dispatch of these four families was found in transferred records. This is bounded evidence about this study, not proof against unrecorded external exposure or training familiarity. The investigator prepared the new cases from pinned public sources; no independent human certification occurred. Three replacements share one upstream project, so their coverage does not establish general reliability.

## What this run will establish

We will test qualification of the verifier, guidance assessor and verifier assessor using Q06/Q09/Q10/Q11, contract v0.2 and unchanged v3 role instructions. Q06 sources, candidates, references and keys remain identical to the preceding bank; its historical compatibility amendments remain disclosed. There are 72 distinct packets, each used twice, giving 144 scheduled responses and 48 per role. Keep their frozen order and the unchanged [four scoring requirements](SCORING-PROCEDURE.md). A new configuration binding and explicit allocation approval are required; preparation alone cannot authorise dispatch.
